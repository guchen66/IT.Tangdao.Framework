...
namespace IT.Tangdao.Framework.Component
{
    internal sealed class TangdaoComponentContext
    {
        /// <summary>
        /// 组件类型
        /// </summary>
        ...
        /// 上级组件上下文
        /// </summary>
        public TangdaoComponentContext CalledContext { get; internal set; }

        /// <summary>
        /// 根组件上下文
        /// </summary>
        public TangdaoComponentContext RootContext { get; internal set; }
