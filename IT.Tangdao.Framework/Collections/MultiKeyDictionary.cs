...
namespace IT.Tangdao.Framework.Collections
{
    ...
    public class MultiKeyDictionary<TValue> : IDictionary<string, TValue>
    {
        ...
        /// <returns></returns>
        private static IEnumerable<string> AllKeys(string key)
        {
            yield return key;
            yield return key + "View";
            yield return key + "ViewModel";
        }
        ...
        public TValue this[string key]
        {
            ...
            set
            {
                var aliasKey = AliasKey(key);
                foreach (var k in AllKeys(aliasKey))
