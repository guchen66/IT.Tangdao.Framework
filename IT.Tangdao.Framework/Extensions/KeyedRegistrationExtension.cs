...
namespace IT.Tangdao.Framework.Extensions
{
    public static class KeyedRegistrationExtension
    {
        ...
        public static ITangdaoContainer RegisterKeyedTransient<TService, TImpl>(this ITangdaoContainer container, object key) where TImpl : TService
            => AddKeyed<TService, TImpl>(container, key, new TransientStrategy());

        public static ITangdaoContainer RegisterKeyedSingleton<TService, TImpl>(this ITangdaoContainer container, object key) where TImpl : TService
            => AddKeyed<TService, TImpl>(container, key, new SingletonStrategy());

        public static ITangdaoContainer RegisterKeyedScoped<TService, TImpl>(this ITangdaoContainer container, object key) where TImpl : TService
